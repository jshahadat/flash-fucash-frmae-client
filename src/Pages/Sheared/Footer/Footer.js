...
const Footer = () => {
    return (
        <div className='mt-10'>
            <footer className="footer items-center p-4 bg-neutral text-neutral-content pl-20 pr-20">
                <div className="items-center grid-flow-col">
                    ...
                    <img src="https://i.ibb.co/0YwTWXS/camera.png" className='h-8 w-8 rounded' alt="" />
